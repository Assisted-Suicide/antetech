...
<html lang="en">
<meta charset="utf-8" />
<meta name="description" content= "Ante Tech: Moving the Technology Industry Forward">
...
<title>Ante Tech - Home</title>
<link rel="shortcut icon" type="image/x-icon" href="logo.ico" />
	<head>
		<script async src="//pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"></script>
		<script>
		(adsbygoogle = window.adsbygoogle || []).push({
		google_ad_client: "ca-pub-7628788520452563",
		enable_page_level_ads: true
		});
		</script>
		<div class="logo">
		<a  href="http://www.antetech.org">
			<img src="header.png" alt="Ante Tech">
		</a>
		</div>
		&nbsp;
		<h1>
	...
	<body>
		...
		<div class="info">
			...
			<p>
				We Move the Technology Industry Forward
			</p>	
			<p>
				Our mission is to make pratical software that is free of charge
			</p>
		</div>
		<div class="footer">
			<address>
